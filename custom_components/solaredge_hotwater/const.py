...
# Consecutive failed state updates that keep the last values instead of turning
# the entities unavailable, so a short outage does not gap the history
TOLERATED_STATE_FAILURES = 3
